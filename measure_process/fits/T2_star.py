...
def fit_Ramsey(x,y, title='', plot=False,freq_init=2e6):
    ...
    fit_params.add('amp', value=0.15, max=1.0, min=-1.0)
    fit_params.add('off', value=0.3, max=1.0, min=-1.0)
    fit_params.add('omega', value=freq_init)
    fit_params.add('phi', value=0)
    fit_params.add('T2', value=3e-6, min = 0)
...
def fit_CPMG(x,y, title='', plot=False):
    ...
    fit_params.add('phi', value=0)
    fit_params.add('T2', value=4e-6, min=1e-7) 
